	...
	<form class="form form--add-lot container <?= $class_name; ?>" action="add.php" method="post" enctype="multipart/form-data">
		...
		<div class="form__container-two">
			...
			<div class="form__item <?= $class_name; ?>">
				...
				<?php $value = isset($_POST['lot-name']) ? $_POST['lot-name'] : ''; ?>
				<input id="lot-name" type="text" name="lot-name" placeholder="Введите наименование лота" required value="<?= $value; ?>">
				<?php $error_message = isset($errors['lot-name']) ? $errors['lot-name'] : ''; ?>
		...
		<div class="form__container-three">
			...
			<div class="form__item form__item--small <?= $class_name; ?>">
				...
				<?php $value = isset($_POST['lot-rate']) ? $_POST['lot-rate'] : ''; ?>
				<input id="lot-rate" type="number" name="lot-rate" placeholder="0" required value="<?= $value; ?>">
				<?php $error_message = isset($errors['lot-rate']) ? $errors['lot-rate'] : ''; ?>
				<span class="form__error"><?= $error_message; ?></span>
			</div>
