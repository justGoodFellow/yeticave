...
Если пользователь ввел неверные данные аккаунта (несуществующий пользователь или неверный пароль), то в сообщении над формой должен быть текст «_Вы ввели неверный_ _email\_\_/пароль_».

## Лоты по категории

Страница состоит из заголовка с текстом: «_Все лоты в категории_ %имя*категории%»,
где %имя*категории% - это название выбранной категории.
...
Страница состоит из заголовка с текстом: «_Результаты поиска по запросу_ %поисковый*запрос%», где %поисковый*запрос % - это текст, который ввел пользователь в строку поиска.
